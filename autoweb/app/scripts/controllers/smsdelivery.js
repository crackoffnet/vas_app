...
/**
 * @ngdoc function
 * @name testApp.controller:SmsdeliveryCtrl
 * @description
 * # SmsdeliveryCtrl
 * Controller of the testApp
 */
angular.module('testApp')
  .controller('SmsdeliveryCtrl', function ($scope, $rootScope, $http, ModalService, ConstantsVAS,pendingRequests,httpService) {
    $rootScope.activePage = "smsdelivery";
    ...
    $scope.sendData = function () {
      ...
      httpService.get(ConstantsVAS.urlPrefixVas + '/vta_vas/sms/destination/374' + msisdn + '/' + start + '/' + end).then(function (res) {
