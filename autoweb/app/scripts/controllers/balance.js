...
/**
 * @ngdoc function
 * @name testApp.controller:BalanceCtrl
 * @description
 * # BalanceCtrl
 * Controller of the testApp
 */
angular.module('testApp')
  .controller('BalanceCtrl', function ($scope, $rootScope, $http, ModalService, ConstantsBCC,pendingRequests,httpService) {
    ...
    $scope.sendData = function () {
      ...
      httpService.get(ConstantsBCC.urlPrefixBcc + '/vta/balance_log/' + msisdn + '/' + start + '/' + end).then(function (res) {
