...
/**
 * @ngdoc function
 * @name testApp.controller:SmssendingCtrl
 * @description
 * # SmssendingCtrl
 * Controller of the testApp
 */
angular.module('testApp')
  .controller('SmssendingCtrl', function ($scope, $rootScope, $http, ModalService, ConstantsVAS,pendingRequests,httpService) {
    $rootScope.activePage = "smssending";
    ...
    $scope.sendData = function () {
      ...
      httpService.get(ConstantsVAS.urlPrefixVas + '/vta_vas/sms/source/374' + msisdn + '/' + start + '/' + end).then(function (res) {
